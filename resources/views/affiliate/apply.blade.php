            ...
            <div class="feature-list">
                <div class="feature-item">
                    ...
                    <div class="feature-text">
                        <strong>Branded Referral Links</strong>
                        <span>Share your custom links and direct traffic to high-converting package pages.</span>
                    </div>
                </div>
                <div class="feature-item">
                    ...
                    <div class="feature-text">
                        ...
                        <span>Track clicks, transactions, and payouts with clear reporting.</span>
                    </div>
                </div>
                <div class="feature-item">
            ...
            <form method="POST" action="{{ route('affiliate.apply.submit') }}">
                ...
                <div class="form-grid">
                    ...
                    <div class="input-group-auth full">
                        ...
                        <textarea id="experience" name="experience" placeholder="Tell us about your audience and promotion experience">{{ old('experience') }}</textarea>
                    </div>
                </div>
        ...
        if (form) {
            form.addEventListener('submit', async function(e) {
                if (typeof window.executeRecaptcha === 'function') {
                    e.preventDefault();
                    const token = await window.executeRecaptcha('affiliate_apply');
                    if (token) {
