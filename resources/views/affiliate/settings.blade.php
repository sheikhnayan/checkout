...
<div class="content-wrapper">
    <div class="container-fluid flex-grow-1 container-p-y">
            ...
            <div class="row align-items-center g-4">
                <div class="col-md-8">
                    ...
                    <div class="input-group mb-3 max-w-lg">
                        <input type="text" id="affiliateShareUrlSettings" class="form-control bg-dark text-white border-secondary" value="{{ $publicUrl }}" readonly>
        ...
        <script>
        function copySettingsShareUrl() {
            const input = document.getElementById('affiliateShareUrlSettings');
            input.select();
            input.setSelectionRange(0, 99999);
            navigator.clipboard.writeText(input.value);
            
            const msg = document.getElementById('copySettingsSuccessMsg');
