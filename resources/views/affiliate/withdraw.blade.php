                ...
                <div class="card p-4">
                    ...
                    <form method="POST" action="{{ route('affiliate.portal.withdraw.methods.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="type" id="affiliateMethodType" required
                                    onchange="renderDetailsFields(this.value, 'affiliateDetailsContainer')">
                        ...
                        <div id="affiliateDetailsContainer"></div>

                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" name="is_default" value="1"
                                   id="affiliateIsDefault" {{ old('is_default') ? 'checked' : '' }}>
                            <label class="form-check-label" for="affiliateIsDefault">Set as default</label>
                        </div>
