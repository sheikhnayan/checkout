                                    ...
                                    <form action="{{ route('admin.event.update', $id) }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                             <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="image" class="form-label">Image <i class="fas fa-circle-info ms-1 field-tip" data-bs-toggle="tooltip" data-bs-placement="top" title="Upload a replacement image. Leave blank to keep the current image."></i></label>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="toggle-field">
                                                            ...
                                                            <label class="toggle-switch" for="show_time_range">
                                                                <input id="show_time_range" type="checkbox" name="show_time_range" value="1" class="toggle-switch-input" {{ old('show_time_range', $data->show_time_range ?? '1') ? 'checked' : '' }}>
