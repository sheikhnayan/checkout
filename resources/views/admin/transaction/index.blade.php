...
<style>
    ...
    .txn-export-btn:hover {
        background: rgba(255, 255, 255, 0.13);
        color: #fff;
    }

    .txn-export-btn::after {
    ...
    .row>div:nth-child(1) .txn-stat-icon {
        animation-delay: 0.08s;
    }

    .row>div:nth-child(2) .txn-stat-icon {
        animation-delay: 0.16s;
    }

    .row>div:nth-child(3) .txn-stat-icon {
        animation-delay: 0.24s;
    }

    .row>div:nth-child(4) .txn-stat-icon {
        animation-delay: 0.32s;
    }

    .row>div:nth-child(5) .txn-stat-icon {
        animation-delay: 0.40s;
    }

    .row>div:nth-child(6) .txn-stat-icon {
    ...
    .txn-pkg-legend-item:last-child {
        border-bottom: none;
    }
    ...
    .txn-table tbody tr.odd {
        background: transparent;
    }

    .txn-table tbody tr.even {
    ...
    #viewTransactionModal .txn-status-completed {
        background: rgba(16, 185, 129, 0.2);
        color: #34d399;
    }

    #viewTransactionModal .txn-status-canceled {
        background: rgba(239, 68, 68, 0.2);
        color: #f87171;
    }

    #viewTransactionModal .txn-status-refunded {
        background: rgba(245, 158, 11, 0.2);
        color: #fbbf24;
    }

    #viewTransactionModal .txn-status-unknown {
        background: rgba(107, 114, 128, 0.2);
        color: #cbd5e1;
    }
    ...
    @media (max-width: 768px) {
        ...
        .txn-btn-item .btn i,
        .txn-btn-item.btn i,
        .txn-btn-item.dropdown .dropdown-toggle i,
        .txn-btn-item .btn .form-check-input {
            margin: 0 4px 0 0 !important;
            flex-shrink: 0 !important;
            display: inline-block !important;
        }

        .txn-btn-item.dropdown .dropdown-toggle::after {
            display: inline-block !important;
    ...
    @if( !\App\Models\Setting::showMetricTrends()) .shopify-delta-badge,
    .growth-tag,
    .txn-stat-trend,
    .metric-trend-badge,
    [data-metric-trend] {
...
<div class="content-wrapper">
    <div class="container-fluid flex-grow-1 container-p-y pt-4">
        ...
        <div class="txn-table-card mb-5">
            ...
            <div class="mb-3 py-2 px-3 rounded-3 txn-toolbar-container" style="background: rgba(15, 23, 42, 0.5); border: 1px solid rgba(255, 255, 255, 0.08); backdrop-filter: blur(8px);">
                <div class="d-flex align-items-center justify-content-between flex-nowrap gap-2 overflow-x-auto txn-toolbar-row" style="-webkit-overflow-scrolling: touch; scrollbar-width: none;">
                    <div class="d-flex align-items-center justify-content-between gap-2 flex-nowrap w-100">
                        <div class="d-flex align-items-center gap-2 flex-nowrap txn-left-actions">
                            @if($canArchiveTransactions)
                            {{-- Selection Count Dropdown Pill --}}
                            <div class="dropdown flex-shrink-0 txn-btn-item txn-btn-select-pill">
                            ...
                            @if($isArchivedView)
                            <button type="button" id="bulkUnarchiveBtn" class="txn-export-btn btn flex-shrink-0 d-inline-flex align-items-center gap-1.5 txn-btn-item txn-btn-archive" style="border-color: rgba(16, 185, 129, 0.4); color: #34d399; font-size: 0.8rem; padding: 6px 12px; white-space:nowrap;">
                                <i class="fas fa-box-open me-2" style="color:#10b981;"></i> Unarchive Selected
                            </button>
                            @else
                            <button type="button" id="bulkArchiveBtn" class="txn-export-btn btn flex-shrink-0 d-inline-flex align-items-center gap-1.5 txn-btn-item txn-btn-archive" style="border-color: rgba(245, 158, 11, 0.4); color: #fbbf24; font-size: 0.8rem; padding: 6px 12px; white-space:nowrap;">
                                <i class="fas fa-box-archive me-2" style="color:#f59e0b;"></i> Archive Selected
                            </button>
                            @endif

                            {{-- Export Table --}}
                            <div class="dropdown flex-shrink-0 txn-btn-item txn-btn-export">
                                <button class="txn-export-btn btn dropdown-toggle d-inline-flex align-items-center gap-1.5" data-bs-toggle="dropdown" type="button" style="font-size:0.8rem; padding:6px 12px; white-space:nowrap;">
                            ...
                            {{-- Select All Pages --}}
                            <button type="button" id="selectAllPagesBtn" class="txn-export-btn btn flex-shrink-0 d-inline-flex align-items-center gap-1.5 txn-btn-item txn-btn-selectall" style="font-size:0.8rem; padding:6px 12px; white-space:nowrap;">
                                <i class="fas fa-check-double me-2" style="color:#818cf8;"></i> Select All Pages
                            </button>

                            {{-- Clear Selection --}}
                            <button type="button" id="clearSelectionBtn" class="txn-export-btn btn flex-shrink-0 d-inline-flex align-items-center gap-1.5 txn-btn-item txn-btn-clear" style="font-size:0.8rem; padding:6px 12px; white-space:nowrap;">
                        ...
                        <div class="dropdown flex-shrink-0 ms-md-auto txn-btn-item txn-columns-item">
                        ...
                        <tr data-row-id="{{ $item->id }}" data-row-error="{{ $rowError ?? '' }}">
                            ...
                            <td class="txn-commission">
                                ...
                                if ($daysRemaining <= 0) {
                                    ...
                                    @endphp
                                    <div style="font-weight:600;">{{ $commissionText }}
            </div>
            </td>
            <td>
                <div class="d-flex align-items-center gap-1">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" style="background:#1e293b;border:1px solid rgba(255,255,255,0.1)">
                            ...
                            <li>
                                <hr class="dropdown-divider" style="border-color:rgba(255,255,255,0.12)">
                            </li>
...
<script>
    ...
    window.updateChartsFromFilteredRows = function() {
        ...
        const filteredRows = activeTable.rows({
            search: 'applied'
        }).nodes();
...
<script>
    $(document).ready(function() {
        ...
        function updateShopifyAnalyticsFromFilteredTable() {
            ...
            const filteredNodes = table.rows({
                filter: 'applied'
            }).nodes();
            ...
            const activeVenues = $('.polaris-filter-cb[data-category="venue"]:checked').map(function() {
                return $(this).val().toLowerCase();
            }).get();
            const activeStatuses = $('.polaris-filter-cb[data-category="status"]:checked').map(function() {
                return $(this).val().toLowerCase();
            }).get();
            const activeTypes = $('.polaris-filter-cb[data-category="type"]:checked').map(function() {
                return $(this).val().toLowerCase();
            }).get();
            const activeAffiliates = $('.polaris-filter-cb[data-category="affiliate"]:checked').map(function() {
                return $(this).val().toLowerCase();
            }).get();
            const activeHosts = $('.polaris-filter-cb[data-category="host"]:checked').map(function() {
                return $(this).val().toLowerCase();
            }).get();
            ...
            const prevTotals = chartWindow.prevTotals || {
                sales: 0,
                orders: 0,
                sessions: 0,
                conversion: 0
            ...
            $('#shopifySalesVal').text('$' + cardSales.toLocaleString('en-US', {
                ...
                if (sMom.isValid() && eMom.isValid() && eMom.isSameOrAfter(sMom)) {
                    ...
                    if (sMom.isSameOrBefore(eMom, 'day')) {
                        ...
                        while (curr.isSameOrBefore(eMom, 'day')) {
                            ...
                            dates.push(dKey);
                            targetMap[dKey] = (dailyMap && dailyMap[dKey]) ? dailyMap[dKey] : (allDailyMap[dKey] || {
                                sales: 0,
                                orders: 0,
                                guests: 0
                            });
        ...
        function drawShopifyChartDataset(dailyMap, metric, allDailyMap) {
            ...
            if (dates.length > 0) {
                dates.forEach(function(d, idx) {
                    ...
                    const prevItem = (prevD && allDailyMap && allDailyMap[prevD]) ? allDailyMap[prevD] : {
                        sales: 0,
                        orders: 0
                    };
        ...
        $.fn.dataTable.ext.search.push(function(settings, data, dataIndex) {
            ...
            const activeReservations = $('.polaris-filter-cb[data-category="reservation"]:checked').map(function() {
                return $(this).val();
            }).get();
        ...
        function getExportDataset() {
            ...
            if (dt && dt.rows && typeof dt.rows === 'function') {
                try {
                    ...
                    const exportRowsApi = selectedOnly ? dt.rows() : dt.rows({
                        search: 'applied'
                    });
        ...
        function updateTotal() {
            ...
            $('#amount-total').text('$' + total.toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            }));
        }
        ...
        function updateDashboardCardsFromFilteredRows() {
            ...
            setStatValueByLabel('Total Revenue', '$' + totalRevenue.toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            }));
            setStatValueByLabel('Pending Fee', '$' + pendingFee.toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            }));
            setStatValueByLabel('Total Guests', totalGuests.toLocaleString());
            setStatValueByLabel('Pending Amount', '$' + pendingAmount.toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            }));
            setStatValueByLabel('Payout Amount', '$' + payoutAmount.toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            }));
            setStatValueByLabel('Total Earning', '$' + totalEarning.toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            }));
...
<script>
    ...
    (function() {
        ...
        if (viewModal && scrollBox) {
            ...
            viewModal.addEventListener('show.bs.modal', function() {
                savedLeft = scrollBox.scrollLeft;
            });
            viewModal.addEventListener('hidden.bs.modal', function() {
                requestAnimationFrame(function() {
                    scrollBox.scrollLeft = savedLeft;
                });
            });
        }
    })();
    ...
    window.fetchClubLifterCustomerStatus = function(customerId, $modal) {
        ...
        $.ajax({
            ...
            success: function(res) {
                var safeEsc = window.txnEsc || function(v) {
    ...
    $(document).on('click', '.view-btn', function() {
        ...
        var normalizeCartItems = function(value) {
            ...
            if (objectValues.length && objectValues.every(function(v) {
        ...
        if (!purchaseItems.length) {
            var summarized = window.summarizePackageItems ? window.summarizePackageItems(cartItems) : {
                items: []
            };
        ...
        if (breakdownData && typeof breakdownData === 'object') {
            ...
            if (parseFloat(breakdownData.promo_discount) > 0) {
                html += line('Discounted Amount', '-' + money(breakdownData.promo_discount), {
                    color: '#34d399'
                });
            } else {
            ...
            html += line('Grand Total', money(breakdownData.grand_total), {
                color: '#fbbf24',
                weight: '700',
                border: true
            });
            if (breakdownData.refundable && breakdownData.refundable.enabled && parseFloat(breakdownData.refundable.amount) > 0) {
                html += line((breakdownData.refundable.name || 'Non-refundable Deposit') + ' (incl. in total)', money(breakdownData.refundable.amount), {
                    color: '#94a3b8',
                    weight: '500'
                });
            }
            html += line('Amount Paid', money(breakdownData.amount_paid_now), {
                color: '#34d399',
                weight: '700'
            });
            if (parseFloat(breakdownData.remaining_due) > 0) {
                html += line('Amount Due', money(breakdownData.remaining_due), {
                    color: '#ef4444',
                    weight: '700'
                });
            } else {
                html += line('Amount Due', money(0), {
                    color: '#ef4444',
                    weight: '700'
                });
            }
...
<script>
        ...
        try {
            ...
            if (payload && Array.isArray(payload.packageItems) && payload.packageItems.length) {
                ...
                doc.autoTable({
                    startY: currentY,
                    head: [
                        ['Package', 'Qty', 'Unit Price', 'Line Total', 'Add-ons']
                    ],
                    body: packageBody,
                    theme: 'grid',
                    margin: {
                    ...
                    columnStyles: {
                        ...
                        4: {
                            cellWidth: contentWidth - (36 + 22 + 24 + 24)
                        }
                    }
                });
    ...
    $(document).on('click', '.btn-link-package', function(e) {
        ...
        var packageSummary = window.summarizePackageItems ? window.summarizePackageItems(cartItems) : {
            items: [],
            totalQuantity: 0,
            totalAddons: 0,
            addonSummaryText: '',
            summaryText: packageLabel
        };
        var breakdownItems = [];
        ...
        if (packageLineupItems.length) {
            ...
            packageLineupItems.forEach(function(item) {
                ...
                var addonQtyTotal = addonEntries.reduce(function(sum, addon) {
        ...
        if (packageLineupItems.length) {
            ...
            packageLineupItems.forEach(function(item, index) {
                ...
                var addonPriceTotal = addonEntries.reduce(function(sum, addon) {
                    return sum + (addon.lineTotal || 0);
                }, 0);
                var hasAddonPrice = addonEntries.some(function(addon) {
                    return addon.unitPrice != null;
                });
        ...
        if (breakdown && typeof breakdown === 'object') {
            ...
            if (parseFloat(breakdown.promo_discount) > 0) {
                html += line('Discount', '-' + money(breakdown.promo_discount), {
                    color: '#34d399'
                });
            }
            ...
            html += line('Grand Total', money(breakdown.grand_total), {
                color: '#fbbf24',
                weight: '700',
                border: true
            });
            if (breakdown.refundable && breakdown.refundable.enabled && parseFloat(breakdown.refundable.amount) > 0) {
                html += line((breakdown.refundable.name || 'Non-refundable Deposit') + ' (incl. in total)', money(breakdown.refundable.amount), {
                    muted: true
                });
            }
            html += line('Amount Paid', money(breakdown.amount_paid_now), {
                color: '#34d399',
                weight: '600'
            });
            if (parseFloat(breakdown.remaining_due) > 0) {
                html += line('Remaining Due', money(breakdown.remaining_due), {
                    color: '#ef4444',
                    weight: '600'
                });
            }
        ...
        try {
            ...
            if (Array.isArray(payload.packageItems) && payload.packageItems.length) {
                ...
                doc.autoTable({
                    startY: currentY,
                    head: [
                        ['Package', 'Description', 'Qty', 'Unit', 'Total', 'Add-ons']
                    ],
                    body: packageBody,
                    theme: 'grid',
                    margin: {
                    ...
                    columnStyles: {
                        ...
                        5: {
                            cellWidth: contentWidth - (28 + 42 + 20 + 20 + 20)
                        }
                    }
                });
                currentY = doc.lastAutoTable.finalY + 2.5;
