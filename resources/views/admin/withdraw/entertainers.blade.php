                            ...
                            <td style="min-width:180px;">
                                <div class="d-flex align-items-center gap-1">
                                    <button type="button" class="txn-action-eye view-btn btn btn-sm btn-outline-secondary"
                                        ...
                                        data-owner_name="{{ $ent ? ($ent->display_name ?: ($ent->user->name ?? 'Entertainer #'.$wr->owner_id)) : 'Entertainer #'.$wr->owner_id }}"
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end" style="background:#1e293b;border:1px solid rgba(255,255,255,0.1)">
                                            <li><a class="dropdown-item" style="color:rgba(255,255,255,0.7);font-size:0.82rem" href="{{ route('admin.withdraw.entertainers.status', [$wr->id, 'done']) }}"><i class="fas fa-check me-2 text-success"></i>Mark Done</a></li>
                                            <li><a class="dropdown-item" style="color:rgba(255,255,255,0.7);font-size:0.82rem" href="{{ route('admin.withdraw.entertainers.status', [$wr->id, 'rejected']) }}"><i class="fas fa-times me-2 text-danger"></i>Mark Rejected</a></li>
                                        </ul>
                                    </div>
