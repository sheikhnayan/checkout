    ...
    <div class="row g-4">
      ...
      <div class="col-lg-6">
        <div class="card h-100">
          ...
          <div class="card-body">
            <div class="mb-3">
              <label class="form-label text-muted small text-uppercase fw-bold">Net Sales ($)</label>
              <input type="number" step="0.01" name="net_sales" class="form-control" value="{{ $report->net_sales }}" required />
            </div>
            <div class="mb-3">
              <label class="form-label text-muted small text-uppercase fw-bold">Nightly Goal ($)</label>
              <input type="number" step="0.01" name="nightly_goal" class="form-control" value="{{ $report->nightly_goal }}" />
            </div>
            <div class="row g-2 mb-3">
              <div class="col-6">
                <label class="form-label text-muted small text-uppercase fw-bold">Actual Deposit ($)</label>
                <input type="number" step="0.01" name="deposit" class="form-control" value="{{ $report->deposit }}" />
              </div>
              <div class="col-6">
                <label class="form-label text-muted small text-uppercase fw-bold">Safe Balance ($)</label>
                <input type="number" step="0.01" name="safe_balance" class="form-control" value="{{ $report->safe_balance }}" />
              </div>
            </div>
            <div class="row g-2">
              <div class="col-4">
                <label class="form-label text-muted small text-uppercase fw-bold">Taxi ($)</label>
                <input type="number" step="0.01" name="taxi_payout" class="form-control" value="{{ $report->taxi_payout }}" />
              </div>
              <div class="col-4">
                <label class="form-label text-muted small text-uppercase fw-bold">ATM ($)</label>
      ...
      <div class="col-lg-6">
        <div class="card h-100">
          ...
          <div class="card-body">
            <div class="row g-2 mb-3">
              <div class="col-6">
                <label class="form-label text-muted small text-uppercase fw-bold">Total Guests</label>
                <input type="number" name="total_guests" class="form-control" value="{{ $report->total_guests }}" required />
              </div>
              <div class="col-6">
                <label class="form-label text-muted small text-uppercase fw-bold">Paid Guests</label>
                <input type="number" name="paid_guests" class="form-control" value="{{ $report->paid_guests }}" />
              </div>
            </div>
            <div class="row g-2 mb-3">
              <div class="col-6">
                <label class="form-label text-muted small text-uppercase fw-bold">Free / Discount Guests</label>
                <input type="number" name="free_discount_guests" class="form-control" value="{{ $report->free_discount_guests }}" />
              </div>
              <div class="col-6">
                <label class="form-label text-muted small text-uppercase fw-bold">Passes Redeemed</label>
                <input type="number" name="passes_redeemed" class="form-control" value="{{ $report->passes_redeemed }}" />
              </div>
            </div>
            <div class="mb-3">
              <label class="form-label text-muted small text-uppercase fw-bold">Weather</label>
              <input type="text" name="weather" class="form-control" value="{{ $report->weather }}" />
            </div>
            <div class="mb-3">
              <label class="form-label text-muted small text-uppercase fw-bold">Superstar Nomination</label>
      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <div class="mb-3">
              <label class="form-label text-muted small text-uppercase fw-bold">Executive Night Summary</label>
              <textarea name="night_summary" class="form-control" rows="3">{{ $report->night_summary }}</textarea>
            </div>
            <div class="row g-3">
              <div class="col-md-6">
                <label class="form-label text-muted small text-uppercase fw-bold">Team Member Notes</label>
                <textarea name="team_member_notes" class="form-control" rows="2">{{ $report->team_member_notes }}</textarea>
              </div>
              <div class="col-md-6">
                <label class="form-label text-muted small text-uppercase fw-bold">IPE / Entertainer Notes</label>
