                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="guest_limit_type" class="form-control" id="guest_limit_type" required>
                                                            <option value="per_group" {{ old('guest_limit_type', $data->guest_limit_type ?? 'per_group') === 'per_group' ? 'selected' : '' }}>Per group</option>
                                                            <option value="per_person" {{ old('guest_limit_type', $data->guest_limit_type ?? 'per_group') === 'per_person' ? 'selected' : '' }}>Per person</option>
                                                        </select>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" name="number_of_guest" class="form-control" value="{{ old('number_of_guest', $data->number_of_guest) }}" id="number_of_guest" placeholder="Enter maximum amount of guests" min="1" required>
