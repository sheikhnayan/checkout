                                                    ...
                                                    <div class="mb-3">
                                                        <div class="toggle-field">
                                                            ...
                                                            <label class="toggle-switch" for="physical_product_enabled">
                                                                <input id="physical_product_enabled" type="checkbox" name="physical_product_enabled" value="1" class="toggle-switch-input" @checked(old('physical_product_enabled', $data->physical_product_enabled == 1))>
                                                                <span class="toggle-switch-slider"></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="toggle-field">
                                                            ...
                                                            <label class="toggle-switch" for="is_most_popular">
                                                                <input id="is_most_popular" type="checkbox" name="is_most_popular" class="toggle-switch-input" @checked(old('is_most_popular', $data->is_most_popular == 1))>
                                                                <span class="toggle-switch-slider"></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        @if(!empty($data->image))
                                                            ...
                                                            <img src="{{ asset('uploads/' . $data->image) }}" alt="Current package image" style="width:110px;height:70px;object-fit:cover;border-radius:8px;border:1px solid #d7dce4;">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        @if(!empty($data->mobile_image))
                                                            <small class="text-muted d-block mt-1">Current:</small>
                                                            <img src="{{ asset('uploads/' . $data->mobile_image) }}" alt="Current package mobile image" style="width:110px;height:70px;object-fit:cover;border-radius:8px;border:1px solid #d7dce4;">
                                                            <div class="form-check mt-2">
