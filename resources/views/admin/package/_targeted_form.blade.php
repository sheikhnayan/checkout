        ...
        <div class="row">
                ...
                <div class="mb-3">
                    <div class="toggle-field">
                        ...
                        <label class="toggle-switch" for="physical_product_enabled">
                            <input id="physical_product_enabled" type="checkbox" name="physical_product_enabled" value="1" class="toggle-switch-input" @checked(old('physical_product_enabled', optional($formData)->physical_product_enabled == 1))>
                            <span class="toggle-switch-slider"></span>
                        </label>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                <div class="mb-3">
                    ...
                    <textarea name="tooltip" class="form-control" id="tooltip" rows="2" placeholder="Short info shown when customers click the i icon">{{ old('tooltip', optional($formData)->tooltip) }}</textarea>
                </div>
            </div>
