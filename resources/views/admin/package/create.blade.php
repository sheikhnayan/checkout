                                    ...
                                    <form action="{{ route('admin.package.store') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="event_id" class="form-control" id="event_id">
                                                            <option value="" {{ old('event_id') ? '' : 'selected' }}>No Event</option>
                                                ...
                                                <div class="col-md-6" id="only-for-events-wrap" style="display: {{ old('event_id') ? 'block' : 'none' }};">
                                                    <div class="mb-3">
                                                        <div class="toggle-field">
                                                            ...
                                                            <label class="toggle-switch" for="only_for_events">
                                                                <input id="only_for_events" type="checkbox" name="only_for_events" class="toggle-switch-input" @checked(old('only_for_events'))>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="tooltip" class="form-control" id="tooltip" rows="2" placeholder="Short info shown when customers click the i icon">{{ old('tooltip') }}</textarea>
                                                    </div>
                                                </div>
