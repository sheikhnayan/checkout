                        ...
                        <div class="app-page-title mt-3">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>
                                        <span class="text-capitalize fs-4 fw-bold">Edit Invoice #{{ $customInvoice->id }}</span>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <textarea name="notes" id="notes" class="form-control" rows="3" placeholder="Optional notes for customer to see...">{{ old('notes', $customInvoice->notes) }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <textarea name="internal_notes" id="internal_notes" class="form-control" rows="3" style="background-color: #fffbeb; border-color: #fcd34d;" placeholder="Private staff notes (not visible to customer)...">{{ old('internal_notes', $customInvoice->internal_notes) }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
