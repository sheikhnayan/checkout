...
@php
  ...
  $updateRoute = $isNightly ? 'admin.nightly-reports.jobs.update' : 'admin.jobs.update';
@endphp
<div class="content-wrapper">
    <div class="container-fluid flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="mb-0 text-white">Edit Job Post</h4>
            <a href="{{ route($indexRoute) }}" class="btn btn-outline-light">Back</a>
        </div>

        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route($updateRoute, $job) }}">
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="skills_text" class="form-control" rows="4">{{ old('skills_text', is_array($job->skills) ? implode("\n", $job->skills) : '') }}</textarea>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="tags_text" class="form-control" rows="2" placeholder="#HiringImmediately, Bartending, Tips Included">{{ old('tags_text', is_array($job->tags) ? implode(", ", $job->tags) : '') }}</textarea>
