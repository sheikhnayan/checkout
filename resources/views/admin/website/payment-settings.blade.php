                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <p class="small mb-3" style="color: #6c757d;">Number of days after a transaction before promoter/entertainer commissions are released. Leave blank to use the system default.</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
