                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <p class="text-muted small mb-3">Fee applied to all transactions. promoter fees are calculated on the amount BEFORE this fee.</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <p class="small mb-3" style="color: #6c757d;">Number of days after a transaction before promoter fees are released. Leave blank to use the system default.</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
