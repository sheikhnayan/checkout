                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="color" name="color" class="form-control form-control-color" id="color" placeholder="Color" required style="height: 38px; width: 100px; padding: 2px;">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="color" name="secondary_color" class="form-control form-control-color" id="secondary_color" placeholder="Secondary Color" required style="height: 38px; width: 100px; padding: 2px;">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="color" name="background_color" class="form-control form-control-color" id="background_color" placeholder="Background Color" required style="height: 38px; width: 100px; padding: 2px;">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="color" name="font_color" class="form-control form-control-color" id="font_color" value="#000000" title="Choose font color">
