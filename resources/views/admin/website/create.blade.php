  ...
  #suggestions li:hover {
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
                                    ...
                                    <form action="{{ route('admin.website.store') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="dispatcher_phone" class="form-control @error('dispatcher_phone') is-invalid @enderror" id="dispatcher_phone" value="{{ old('dispatcher_phone') }}" placeholder="+1 555 123 4567">
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="toggle-field">
                                                            ...
                                                            <label class="toggle-switch" for="is_physical_product_checkout">
                                                                <input id="is_physical_product_checkout" type="checkbox" name="is_physical_product_checkout" value="1" class="toggle-switch-input" {{ old('is_physical_product_checkout') ? 'checked' : '' }}>
                                                                <span class="toggle-switch-slider"></span>
                                                            </label>
                                                        </div>
                                            ...
                                            <div class="col-md-12 mt-2">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="website_admin_password" class="form-label">Website Admin Password <i class="fas fa-circle-info ms-1 field-tip" data-bs-toggle="tooltip" data-bs-placement="top" title="Password for the website admin account. Minimum 8 characters."></i></label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="website_admin_password_confirmation" class="form-label">Confirm Password <i class="fas fa-circle-info ms-1 field-tip" data-bs-toggle="tooltip" data-bs-placement="top" title="Re-enter the password to confirm it matches."></i></label>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="toggle-field">
                                                            ...
                                                            <label class="toggle-switch" for="clublifter_enabled">
                                                                <input id="clublifter_enabled" type="checkbox" name="clublifter_enabled" value="1" class="toggle-switch-input" {{ old('clublifter_enabled') ? 'checked' : '' }}>
                                                                <span class="toggle-switch-slider"></span>
                                                            </label>
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="hero_title" class="form-control" id="hero_title" placeholder="Main headline for public page">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="hero_subtitle" class="form-control" id="hero_subtitle" placeholder="Short supporting line under hero title">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="hero_badge_1_label" class="form-control" id="hero_badge_1_label" value="{{ old('hero_badge_1_label') }}" placeholder="Open Daily">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="hero_badge_1_sub" class="form-control" id="hero_badge_1_sub" value="{{ old('hero_badge_1_sub') }}" placeholder="6PM - 7AM">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="hero_badge_2_label" class="form-control" id="hero_badge_2_label" value="{{ old('hero_badge_2_label') }}" placeholder="Top Rated Club">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="hero_badge_2_sub" class="form-control" id="hero_badge_2_sub" value="{{ old('hero_badge_2_sub') }}" placeholder="#1 in Las Vegas">
                                                    </div>
                                                </div>
                                                ...
                                                {{-- <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="secondary_description" class="form-control" id="secondary_description" rows="3" placeholder="Additional section text for the new layout"></textarea>
                                                    </div>
                                                </div> --}}
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <div class="toggle-field">
                                                        ...
                                                        <label class="toggle-switch" for="show_transportation_consent">
                                                            <input id="show_transportation_consent" type="checkbox" name="show_transportation_consent" value="1" class="toggle-switch-input" {{ old('show_transportation_consent', 1) == 1 ? 'checked' : '' }}>
                                                            <span class="toggle-switch-slider"></span>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <textarea name="transportation_confirmation_text" class="form-control" id="transportation_confirmation_text" rows="2" placeholder="Leave blank to use default fallback text">{{ old('transportation_confirmation_text') }}</textarea>
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <div class="toggle-field">
                                                        ...
                                                        <label class="toggle-switch" for="show_sms_consent">
                                                            <input id="show_sms_consent" type="checkbox" name="show_sms_consent" value="1" class="toggle-switch-input" {{ old('show_sms_consent', 1) == 1 ? 'checked' : '' }}>
                                                            <span class="toggle-switch-slider"></span>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <textarea name="sms_consent_text" class="form-control" id="sms_consent_text" rows="2" placeholder="Leave blank to use default fallback text">{{ old('sms_consent_text') }}</textarea>
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <div class="toggle-field">
                                                        ...
                                                        <label class="toggle-switch" for="show_terms_consent">
                                                            <input id="show_terms_consent" type="checkbox" name="show_terms_consent" value="1" class="toggle-switch-input" {{ old('show_terms_consent', 1) == 1 ? 'checked' : '' }}>
                                                            <span class="toggle-switch-slider"></span>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <textarea name="terms_consent_text" class="form-control" id="terms_consent_text" rows="2" placeholder="Leave blank to use default fallback text">{{ old('terms_consent_text') }}</textarea>
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <div class="toggle-field">
                                                        ...
                                                        <label class="toggle-switch" for="show_business_expense_consent">
                                                            <input id="show_business_expense_consent" type="checkbox" name="show_business_expense_consent" value="1" class="toggle-switch-input" {{ old('show_business_expense_consent', 0) == 1 ? 'checked' : '' }}>
                                                            <span class="toggle-switch-slider"></span>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input type="text" name="business_expense_text" class="form-control" id="business_expense_text" value="{{ old('business_expense_text') }}" placeholder="Leave blank to use default fallback text">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="back_text" class="form-control" id="back_text" placeholder="Back Button Text">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="back_link" class="form-control" id="privacy_policy" placeholder="Back Button Link">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="footer_text" class="form-control" id="terms_conditions" placeholder="Footer Text">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
            ...
            (function restoreOldFormValues() {
                ...
                if (rawEmails) {
                    ...
                    if (Array.isArray(parsedEmails) && parsedEmails.length > 0) {
                        ...
                        parsedEmails.forEach(function (item) {
                ...
                if (rawEntertainerSubmissionEmails) {
                    ...
                    if (Array.isArray(parsedEntertainerSubmissionEmails) && parsedEntertainerSubmissionEmails.length > 0) {
                        ...
                        parsedEntertainerSubmissionEmails.forEach(function (item) {
                            const name = item && item.name ? item.name : '';
                            const email = item && item.email ? item.email : '';
            ...
            // If the admin email already belongs to a website admin, hide the password fields
            // (they reuse their existing password). If it belongs to another account type, warn.
            (function initWebsiteAdminEmailCheck() {
                ...
                function setRequired(req) {
                    if (req) { passInput.setAttribute('required', 'required'); confirmInput.setAttribute('required', 'required'); }
                    else { passInput.removeAttribute('required'); confirmInput.removeAttribute('required'); }
                }
                ...
                function apply(status, name) {
                    if (status === 'reuse') {
                        ...
                        showFields(false); setRequired(false);
                        ...
                        showFields(true); setRequired(true);
                ...
                function check() {
                    ...
                    fetch(checkUrl + '?email=' + encodeURIComponent(email), { headers: { 'X-Requested-With': 'XMLHttpRequest', 'Accept': 'application/json' }, credentials: 'same-origin' })
