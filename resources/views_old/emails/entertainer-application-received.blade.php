...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Your Entertainer Application Has Been Submitted Successfully</p>
        </div>

        <div class="content">
            <p class="greeting">Hello {{ $entertainer->display_name ?? $entertainer->user->name }},</p>

            <p class="message">Thank you for applying to CartVIP! We're excited about your interest in becoming an entertainer on our platform. We've successfully received your application and it's now in our review queue.</p>
            ...
            <div class="timeline">
                <div class="timeline-item">
                    ...
                    <div class="timeline-text"><strong>Application Review</strong><br>Our admin team will carefully review your profile, experience, and qualifications.</div>
                </div>
                <div class="timeline-item">
                ...
                <div class="timeline-item">
                    ...
                    <div class="timeline-text"><strong>Account Activation</strong><br>Once approved, you can log in and start building your entertainer profile.</div>
                </div>
            </div>
