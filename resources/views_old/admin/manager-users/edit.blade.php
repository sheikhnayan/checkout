                    ...
                    <div class="app-page-title mt-4">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div><span class="text-capitalize">Edit Manager User</span></div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg">
                            <div class="card-shadow-primary card-border text-white mb-3 card bg-primary">
                                <form action="{{ route('admin.manager-users.update', $manager->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label for="password" class="form-label">
                                                    New Password <small class="text-white-50">(leave blank to keep current)</small> <i class="fas fa-circle-info ms-1 field-tip" data-bs-toggle="tooltip" data-bs-placement="top" title="Enter a new password to change the current one. Leave blank to keep the existing password."></i>
                                                </label>
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <select name="website_role_id" id="website_role_id"
                                                    ...
                                                    @foreach($roles as $role)
                                                        @php
                                                            $selected = old('website_role_id', $manager->website_role_id) == $role->id;
                                                        @endphp
                                        ...
                                        @php
                                            $currentlyAssigned = old('website_ids')
                                                ? array_map('intval', old('website_ids'))
                                                : $assignedWebsiteIds;
                                        @endphp
                                                ...
                                                @foreach($websites as $website)
                                                    <label class="club-checkbox-item">
                                                        <input type="checkbox"
                                                            ...
                                                            value="{{ $website->id }}"
                                                            class="club-checkbox"
                                                            {{ in_array($website->id, $currentlyAssigned) ? 'checked' : '' }}>
                                                        <span>
                                                            {{ $website->name }}
                                                            @if($website->domain)
                                        ...
                                        <div class="mt-4">
                                            <button type="submit" class="btn btn-success">
                                                <i class="fas fa-save"></i> Update Manager User
                                            </button>
