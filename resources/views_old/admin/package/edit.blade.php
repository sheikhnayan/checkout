                                                    ...
                                                    <div class="mb-3">
                                                        <div class="toggle-field">
                                                            ...
                                                            <label class="toggle-switch" for="physical_product_enabled">
                                                                <input id="physical_product_enabled" type="checkbox" name="physical_product_enabled" class="toggle-switch-input" @checked(old('physical_product_enabled', $data->physical_product_enabled == 1))>
                                                                <span class="toggle-switch-slider"></span>
                                                            </label>
                                                        </div>
                                                    </div>
