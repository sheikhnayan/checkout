                ...
                <form method="POST" action="{{ route('admin.jobs.update', $job) }}">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="city" class="form-control" value="{{ old('city', $job->city) }}" placeholder="Miami">
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="state" class="form-control" value="{{ old('state', $job->state) }}" placeholder="FL">
                        </div>
