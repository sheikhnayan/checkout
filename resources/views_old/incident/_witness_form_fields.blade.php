<div class="row g-3">
    ...
    <div class="col-md-4">
        ...
        <input type="date" name="date_submitted" class="form-control" value="{{ old('date_submitted', now($incident->website?->resolved_timezone ?? 'America/Los_Angeles')->format('Y-m-d')) }}" required>
    </div>
    <div class="col-md-4">
