...
{
    private const CLIENT_CONFIRMATION_MESSAGE = 'CartVIP reservation confirmed! Keep this QR code ready—it will be required for transportation (if included) and venue check-in. Your complete reservation details have been emailed. Reply STOP to opt out.';
