...
class EntertainerAdminController extends Controller
{
    ...
    public function approve(Entertainer $entertainer)
    {
        ...
        $entertainer->commission_hold_days = request()->input('commission_hold_days') !== '' && request()->input('commission_hold_days') !== null
            ...
            : null;
        $entertainer->allow_custom_invoice = request()->boolean('allow_custom_invoice');
    ...
    public function updateCommission(Request $request, Entertainer $entertainer)
    {
        ...
        $request->validate([
            'default_commission_percentage' => 'required|numeric|min:0|max:100',
            'commission_hold_days' => 'nullable|integer|min:0|max:365',
            'allow_custom_invoice' => 'nullable|boolean',
        ]);
        ...
        return redirect()->back()->with('success', 'Entertainer commission, custom hold period, and invoice permissions updated successfully.');
    }
