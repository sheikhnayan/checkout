    ...
    public function getAvailableCheckoutTemplates(?Website $website = null): array
    {
        ...
        return [
            'default' => [
                'key' => 'default',
                'name' => 'Classic Dark',
                'subtitle' => 'Standard VIP Checkout Flow',
                'badge' => 'Classic Dark',
                ...
                'image' => asset('assets/img/templates/default.jpg'),
                'recommended' => false,
            ],
            'template1' => [
                'key' => 'template1',
                'name' => 'Modern Cobalt',
                'subtitle' => 'Streamlined Single-Page Flow',
                'badge' => 'Modern Cobalt',
                ...
                'image' => asset('assets/img/templates/template1.jpg'),
                'recommended' => false,
            ],
            'template4' => [
                'key' => 'template4',
                'name' => 'Champagne Luxe',
                'subtitle' => 'Step-by-Step Gold Edition',
                'badge' => 'Champagne Luxe',
                'badge_class' => 'bg-warning text-dark',
                'description' => 'Sophisticated champagne gold nightlife design featuring a step-by-step progress flow, dynamic guest count counters, rich package breakdowns, and elevated bottle service presentation.',
                'features' => [
                    'Warm champagne gold gradient styling',
                    'Step-by-step guided checkout flow',
                ...
                'image' => asset('assets/img/templates/template4.jpg'),
                'recommended' => false,
            ],
        ];
    }
