    ...
    public function getAvailableCheckoutTemplates(?Website $website = null): array
    {
        ...
        return [
            'default' => [
                'key' => 'default',
                'name' => 'Classic Dark',
                'subtitle' => 'Deep Midnight & Purple Neon',
                'badge' => 'Classic Dark',
                'badge_class' => 'bg-secondary',
                'description' => 'The signature dark nightlife checkout experience. Features a deep midnight-violet backdrop with glowing neon purple accents, interactive date picker with venue map, tabbed package navigation, and a floating order summary with shareable cart links.',
                'features' => [
                    'Midnight violet nightlife aesthetic with glowing neon accents',
                    'Tabbed category navigation (VIP Packages & Tickets)',
                    'Integrated venue location map & reservation date picker',
                    'Floating order summary with shareable link generation & promo codes',
                    '3-phase guided booking flow (Choose Date → Select Package → Review & Pay)',
                ],
            ...
            'template1' => [
                'key' => 'template1',
                'name' => 'Modern Light',
                'subtitle' => 'Crisp White & Cobalt Blue',
                'badge' => 'Modern Light',
                'badge_class' => 'bg-primary',
                'description' => 'A clean, high-contrast light theme engineered for clear catalog browsing and fast conversion. Features an expanded vertical package list with photo previews, guest count dropdowns, and an inline personal details checkout form directly on the page.',
                'features' => [
                    'Crisp, modern white & slate layout with vibrant cobalt blue accents',
                    'Full vertical package catalog with image thumbnails & guest selectors',
                    'Inline multi-step checkout form (Personal details, Transportation, Payment)',
                    'Phone input with international country flag picker & DOB verification',
                    'Clean sidebar with empty-state cart guidance & trust assurance badges',
                ],
                'preview_url' => $slug ? route('demo.checkout.template1', $slug) : '#',
                'image' => asset('assets/img/templates/template1.png'),
                'recommended' => false,
            ],
            'template4' => [
                'key' => 'template4',
                'name' => 'Neo-Brutalist',
                'subtitle' => 'Bold Black Borders & Electric Green',
                'badge' => 'Neo-Brutalist',
                'badge_class' => 'bg-dark text-success border border-success',
                'description' => 'An energetic retro-brutalist checkout aesthetic inspired by modern street culture and EDM festivals. Features bold black outlines, hard offset drop shadows, and high-voltage electric neon green accents for high-energy venues.',
                'features' => [
                    'Distinctive neo-brutalist styling with heavy black borders & hard drop shadows',
                    'High-voltage electric neon green (#00ff66) price displays & action buttons',
                    'Solid-boxed 3-step progress bar (Choose Date → Select Package → Review & Pay)',
                    'Bold high-contrast order summary with prominent shareable link generator',
                    'High-energy, eye-catching visual identity tailored for nightlife & festival crowds',
                ],
                'preview_url' => $slug ? route('demo.checkout.template4', $slug) : '#',
                'image' => asset('assets/img/templates/template4.png'),
                'recommended' => false,
            ],
        ];
    }
