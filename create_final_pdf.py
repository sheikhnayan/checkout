...
title_page_field = ParagraphStyle(
    'Field',
    parent=styles['Normal'],
    fontSize=11,
    textColor=colors.HexColor('#000000'),
...
elements.append(Paragraph('Bangladesh University of Business and Technology', title_page_style))
elements.append(Spacer(1, 0.4*inch))

# Note: University logo would go here - for now we skip it
elements.append(Spacer(1, 0.5*inch))

elements.append(Paragraph('ASSIGNMENT', title_page_style))
elements.append(Spacer(1, 0.5*inch))

# Assignment details
elements.append(Paragraph('Course Code&nbsp;&nbsp;&nbsp;&nbsp;: ENG 3102', title_page_field))
elements.append(Paragraph('Course Title&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: 18th Century English Literature', title_page_field))
elements.append(Spacer(1, 0.3*inch))

# Two columns effect using text
elements.append(Paragraph('<b>Submitted By:</b>', title_page_field))
elements.append(Paragraph('Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: Koli Akter', title_page_field))
elements.append(Paragraph('ID No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: 056', title_page_field))
elements.append(Paragraph('Intake&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: 59', title_page_field))
elements.append(Paragraph('Section&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: 1', title_page_field))

elements.append(Spacer(1, 0.3*inch))

elements.append(Paragraph('<b>Submitted To:</b>', title_page_field))
elements.append(Paragraph('Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: Mahmud Sazzad', title_page_field))
elements.append(Paragraph('Dept. of Bangladesh University of Business & Technology', title_page_field))

elements.append(Spacer(1, 0.3*inch))

today = date.today().strftime('%d %B %Y')
elements.append(Paragraph(f'Date of Submission&nbsp;&nbsp;&nbsp;&nbsp;: {today}', title_page_field))
