...
Route::group(['prefix'=> 'admins', 'as' => 'admin.', 'middleware' => ['admin.or.ambassador', 'image.upload.guard', 'route.permission']], function () {
    ...
    Route::group(['prefix'=> 'transaction', 'as' => 'transaction.'], function () {
        ...
        Route::match(['get', 'post'], '/ajax-data', [TransactionController::class, 'ajaxData'])->name('ajax-data');
        Route::post('/filter-ajax', [TransactionController::class,'filterTransactionsAjax'])->name('filter-ajax');
        Route::post('/search-filter-options', [TransactionController::class,'getSearchFilterOptions'])->name('search-filter-options');
        Route::post('/search-ajax', [TransactionController::class,'searchTransactionsAjax'])->name('search-ajax');
...
Route::group(['prefix'=> 'affiliate-portal', 'as' => 'affiliate.portal.', 'middleware' => ['auth', 'image.upload.guard']], function () {
    ...
    // Slug validation
    Route::post('/check-slug-availability', [AffiliatePortalController::class, 'checkSlugAvailability'])->name('check-slug');
});
